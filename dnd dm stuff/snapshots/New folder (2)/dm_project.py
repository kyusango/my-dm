...
def show_primary_skills_screen(character_data):
    ...
    skills = [
        "Appraise", "Balance", "Bluff", "Climb", "Concentration", "Craft (Alchemy)",
...
def show_character_sheet(character_data):
    ...
    for idx, skill in enumerate(skills):
        if idx < len(skills) // 2:  # Left column
    ...
    for skill, (x, y) in skill_coordinates.items():
        ...
        modifier_entry.place(x=x + 220, y=y - 3)
...
def determine_ability(skill):
    ...
    skill_to_ability = {
        "Appraise": "Intelligence", "Balance": "Dexterity", "Bluff": "Charisma",
        "Climb": "Strength", "Concentration": "Constitution", "Craft (Alchemy)": "Intelligence",
        "Craft (Armor)": "Intelligence", "Craft (Weaponsmithing)": "Intelligence",
